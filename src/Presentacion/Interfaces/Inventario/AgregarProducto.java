...
public class AgregarProducto extends VentanaEmergente implements PropertyChangeListener{
    ...
    public void btnAceptarPresionado(MouseEvent evt) {
        if(txtNombre.getText().isBlank()){
                ...
                int departamentoID = departamentoSeleccionado!=null?departamentoSeleccionado.getIdDepartamento():-1;
                ...
                nuevoProducto.setDepartamentoID(departamentoID);
                ControlInventario.agregarProducto(nuevoProducto);
                panelPrincipalDeModuloDeInventario.cargarListaDeProductos(departamentoID);
